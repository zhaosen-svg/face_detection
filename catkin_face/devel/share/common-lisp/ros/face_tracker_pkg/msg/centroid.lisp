...
(cl:in-package face_tracker_pkg-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <centroid>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'centroid)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name face_tracker_pkg-msg:<centroid> is deprecated: use face_tracker_pkg-msg:centroid instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <centroid>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader face_tracker_pkg-msg:x-val is deprecated.  Use face_tracker_pkg-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <centroid>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader face_tracker_pkg-msg:y-val is deprecated.  Use face_tracker_pkg-msg:y instead.")
  (y m))
